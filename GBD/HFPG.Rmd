...
GBD <- readr::read_csv(file = here::here("GBD_measures.csv"))

GBDrates <- readr::read_csv(file = here::here("GBD_rate_of_changes.csv"))
...
rm("GBDrates", "SDI", "GBD_POP_1990_2020") #don't wanna waste my precious RAM...
```
